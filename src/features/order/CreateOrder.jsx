    ...
    <div className="px-4 py-6">
      ...
      <Form method="POST">
        ...
        <div className="relative mb-5 flex flex-col flex-wrap gap-2 sm:flex-row sm:items-center">
          ...
          {addressStatus === "error" && (
            <p className="w-full rounded-full bg-red-100 p-2 text-xs text-red-700">
              {errorAddress}
            </p>
          )}

          {!position.latitude && !position.longitude && (
            <span className="absolute right-[1px] top-0 z-50">
              <Button
                disabled={isLoadingAddress}
                type="small"
                onClick={(e) => {
...
export async function action({ request }) {
  ...
  //DO NOT OVER USE BECAUSE HAVE PROBLEM IN PERFORMANCE AND SECURITY..
